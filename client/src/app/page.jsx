    ...
    return (<div className="w-4 scrollbar-hide min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-12 max-w-5xl mx-auto">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-2 relative">
              {supplyChainFlow.map((item, index) => (<div key={item.step} className="flex flex-col items-center relative z-10 flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-8">
          {menuItems.map((item) => (<button key={item.path} onClick={() => router.push(item.path)} onMouseEnter={() => setHovered(item.path)} onMouseLeave={() => setHovered(null)} className={`
