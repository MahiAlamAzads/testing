...
export default function Supply() {
    ...
    const handlerChangeRMSId = (event) => {
        setRmsId(event.target.value);
    };
    const handlerChangeManId = (event) => {
        setManId(event.target.value);
    };
    const handlerChangeDisId = (event) => {
        setDisId(event.target.value);
    };
    const handlerChangeRetId = (event) => {
        setRetId(event.target.value);
    };
    const handlerChangeSoldId = (event) => {
    ...
    if (loader) {
        return (<div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-orange-50 to-red-100">
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 p-5">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <button onClick={() => router.push('/')} className="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors flex items-center">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          ...
          {Object.keys(med).length === 0 ? (<div className="text-center py-12">
              ...
              <table className="min-w-full">
                ...
                return (<tr key={key} className="hover:bg-orange-50 transition-colors">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-xl p-6 border-l-4 border-blue-500">
            ...
            <form onSubmit={handlerSubmitRMSsupply} className="flex gap-3">
              <div className="flex-1 relative">
                ...
                <input className="w-full pl-12 pr-4 py-3 border-2 border-blue-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg bg-white" type="text" onChange={handlerChangeRMSId} placeholder="Enter Battery ID" value={rmsId} required/>
              </div>
              <button type="submit" className="px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl font-semibold hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl shadow-xl p-6 border-l-4 border-green-500">
            ...
            <form onSubmit={handlerSubmitManufacturing} className="flex gap-3">
              <div className="flex-1 relative">
                ...
                <input className="w-full pl-12 pr-4 py-3 border-2 border-green-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent text-lg bg-white" type="text" onChange={handlerChangeManId} placeholder="Enter Battery ID" value={manId} required/>
              </div>
              <button type="submit" className="px-8 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl font-semibold hover:from-green-600 hover:to-green-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7"/>
                </svg>
                Manufacture
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl shadow-xl p-6 border-l-4 border-purple-500">
            ...
            <form onSubmit={handlerSubmitDistribute} className="flex gap-3">
              <div className="flex-1 relative">
                ...
                <input className="w-full pl-12 pr-4 py-3 border-2 border-purple-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent text-lg bg-white" type="text" onChange={handlerChangeDisId} placeholder="Enter Battery ID" value={disId} required/>
              </div>
              <button type="submit" className="px-8 py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl font-semibold hover:from-purple-600 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7"/>
                </svg>
                Distribute
          ...
          <div className="bg-gradient-to-br from-yellow-50 to-orange-100 rounded-2xl shadow-xl p-6 border-l-4 border-orange-500">
            ...
            <form onSubmit={handlerSubmitRetail} className="flex gap-3">
              <div className="flex-1 relative">
                ...
                <input className="w-full pl-12 pr-4 py-3 border-2 border-orange-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent text-lg bg-white" type="text" onChange={handlerChangeRetId} placeholder="Enter Battery ID" value={retId} required/>
              </div>
              <button type="submit" className="px-8 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl font-semibold hover:from-orange-600 hover:to-orange-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7"/>
                </svg>
                Retail
          ...
          <div className="bg-gradient-to-br from-red-50 to-pink-100 rounded-2xl shadow-xl p-6 border-l-4 border-red-500">
            ...
            <form onSubmit={handlerSubmitSold} className="flex gap-3">
              <div className="flex-1 relative">
                ...
                <input className="w-full pl-12 pr-4 py-3 border-2 border-red-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent text-lg bg-white" type="text" onChange={handlerChangeSoldId} placeholder="Enter Battery ID" value={soldId} required/>
              </div>
              <button type="submit" className="px-8 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl font-semibold hover:from-red-600 hover:to-red-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7"/>
                </svg>
                Mark as Sold
