...
export default function AddMed() {
    ...
    if (loader) {
        return (<div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-green-50 to-emerald-100">
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 p-5">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <button onClick={() => router.push('/')} className="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors flex items-center shadow-lg hover:shadow-xl transform hover:scale-105">
        ...
        {/* Warning Messages */}
        {!isOwner && (<div className="mb-6 p-5 bg-red-50 border-l-4 border-red-500 rounded-xl shadow-lg">
        ...
        {isOwner && (roleCounts.rms === 0 || roleCounts.man === 0 || roleCounts.dis === 0 || roleCounts.ret === 0) && (<div className="mb-6 p-5 bg-yellow-50 border-l-4 border-yellow-500 rounded-xl shadow-lg">
              ...
              <div className={`p-3 rounded-lg border-2 ${roleCounts.rms > 0 ? 'bg-green-50 border-green-300' : 'bg-red-50 border-red-300'}`}>
                <div className="flex items-center mb-2">
                  <svg className={`w-5 h-5 mr-2 ${roleCounts.rms > 0 ? 'text-green-600' : 'text-red-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {roleCounts.rms > 0 ? (<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>) : (<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/>)}
                  </svg>
              ...
              <div className={`p-3 rounded-lg border-2 ${roleCounts.man > 0 ? 'bg-green-50 border-green-300' : 'bg-red-50 border-red-300'}`}>
                <div className="flex items-center mb-2">
                  <svg className={`w-5 h-5 mr-2 ${roleCounts.man > 0 ? 'text-green-600' : 'text-red-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {roleCounts.man > 0 ? (<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>) : (<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/>)}
                  </svg>
              ...
              <div className={`p-3 rounded-lg border-2 ${roleCounts.dis > 0 ? 'bg-green-50 border-green-300' : 'bg-red-50 border-red-300'}`}>
                <div className="flex items-center mb-2">
                  <svg className={`w-5 h-5 mr-2 ${roleCounts.dis > 0 ? 'text-green-600' : 'text-red-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {roleCounts.dis > 0 ? (<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>) : (<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/>)}
                  </svg>
              ...
              <div className={`p-3 rounded-lg border-2 ${roleCounts.ret > 0 ? 'bg-green-50 border-green-300' : 'bg-red-50 border-red-300'}`}>
                <div className="flex items-center mb-2">
                  <svg className={`w-5 h-5 mr-2 ${roleCounts.ret > 0 ? 'text-green-600' : 'text-red-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {roleCounts.ret > 0 ? (<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>) : (<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/>)}
                  </svg>
            ...
            <button onClick={() => router.push('/roles')} className="mt-4 px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm font-semibold flex items-center shadow-lg hover:shadow-xl transform hover:scale-105">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
          ...
          <form onSubmit={handlerSubmitMED} className="space-y-5">
            <div className="relative">
              ...
              <input className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all text-lg" type="text" onChange={handlerChangeNameMED} placeholder="Material Name" value={medName} required disabled={isSubmitting}/>
            </div>
            ...
            <div className="relative">
              ...
              <input className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all text-lg" type="text" onChange={handlerChangeDesMED} placeholder="Material Description" value={medDes} required disabled={isSubmitting}/>
            </div>
            
            <button type="submit" disabled={!isOwner || roleCounts.rms === 0 || roleCounts.man === 0 || roleCounts.dis === 0 || roleCounts.ret === 0 || isSubmitting} className={`w-full px-6 py-4 rounded-xl transition-all font-semibold text-lg flex items-center justify-center shadow-lg ${isOwner && roleCounts.rms > 0 && roleCounts.man > 0 && roleCounts.dis > 0 && roleCounts.ret > 0 && !isSubmitting
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {Object.keys(med).length === 0 ? (<div className="text-center py-12">
              ...
              <table className="min-w-full">
                ...
                return (<tr key={key} className="hover:bg-green-50 transition-colors">
