...
export default function NetworkHelper() {
    ...
    if (!showHelper)
        return null;
    return (<div className="fixed top-4 right-4 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-lg shadow-lg max-w-md z-50">
      <div className="flex items-start">
        ...
        <div className="ml-3 flex-1">
          ...
          <div className="mt-3">
            <button onClick={handleSwitchNetwork} className="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-2 px-4 rounded text-sm">
              Switch to Network 1337
            </button>
            <button onClick={() => setShowHelper(false)} className="ml-2 text-yellow-700 hover:text-yellow-900 text-sm font-medium">
              Dismiss
            </button>
          </div>
        </div>
