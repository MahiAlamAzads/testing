...
export const getContract = async () => {
    ...
    const networkData = deployments.networks[networkIdStr];
    if (networkData && networkData.SupplyChain && networkData.SupplyChain.address) {
        const contract = new web3.eth.Contract(SupplyChainArtifact.abi, networkData.SupplyChain.address);
        ...
        throw new Error(`Contract not found on network ${networkIdStr}.\n\n` +
